    ...
    <div>
        <div class="index">
            <div class="index-main">
                <router-link to="/">
                    <img src="../images/logo-footer.png" class="index-logo">
                </router-link>
                <row type="flex" justify="center" align="middle" class="index-container">
                    <i-col span="24">
                        <h1 style="font-family: monospace;font-size: 68px;font-style: italic;">WIS UI</h1>
                        <!-- <img src="../images/logo-footer.png" class="index-title"> -->
